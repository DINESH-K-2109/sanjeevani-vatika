            ...
            <footer className="p-8 md:flex md:items-center md:justify-between">
                ...
                <div className="mt-8 md:mt-0">
                    ...
                    <div className="flex items-center space-x-2 text-gray-500 dark:text-gray-400">
                        <AiFillPhone size={20} />
                        <span>+91 8168557994 📱</span>
                    </div>
                    <div className="flex items-center space-x-2 mt-2 text-gray-500 dark:text-gray-400">
                        <IoLocationSharp size={20} />
                        <span>Gurur Jambheshwar University of Science and Technology,Hisar🌳</span>
                    </div>
                    <div className="flex items-center space-x-2 mt-2 text-gray-500 dark:text-gray-400">
                        <MdEmail size={20} />
                        <span><a href="mailto:manishajaishwal8168557994@gmail.com" className="hover:underline">manishajaishwal8168557994@gmail.com 📧</a></span>
                    </div>
                </div>
